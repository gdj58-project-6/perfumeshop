						...
						<div class="m-l-25 m-r--38 m-lr-0-xl">
							<div class="wrap-table-shopping-cart">
								<table class="table-shopping-cart">
									...
									<tr>
										<td style="width: 150px;"><img src="${pageContext.request.contextPath}/upload/${goodsOne.filename}" width="150" height="150"></td>
										<td style="width: 400px;">${goodsOne.goodsName}</td>
										<td style="width: 100px;"><fmt:formatNumber value="${goodsOne.goodsPrice}" pattern="###,###,###" /></td>
										<td style="width: 50px;">${goodsQuantity}</td>
										<td style="width: 200px;">
											...
											<fmt:formatNumber value="${goodsOne.goodsPrice * goodsQuantity}" pattern="###,###,###" />
										</td>
