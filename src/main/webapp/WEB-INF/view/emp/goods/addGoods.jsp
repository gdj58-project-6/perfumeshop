	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/admin/addGoods" method="post" enctype="multipart/form-data">
			<div class="bor19 size-218 m-b-20">
				상품이름  <input class="stext-111 cl2 plh3 size-100 p-lr-18"  type="text" name="goodsName">
			</div>
			<div class="bor19 size-218 m-b-20">
				상품가격  <input class="stext-111 cl2 plh3 size-100 p-lr-18" type="number" name="goodsPrice">
			</div>	
			<div class="m-b-20">
				상품종류 
